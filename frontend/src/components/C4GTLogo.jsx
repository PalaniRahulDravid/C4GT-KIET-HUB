...
export default function C4GTLogo({ 
  ...
  return (
    <div className={`inline-flex items-center gap-3 select-none ${className}`}>
      ...
      <div className={`flex-shrink-0 flex items-center justify-center ${isDark ? 'bg-white/95 p-1 rounded-xl shadow-xs border border-white/20' : ''}`}>
        <img
          src={logoImg}
          alt="C4GT HUB @KIET Logo"
          className={`${imgClassName} w-auto object-contain ${isDark ? '' : 'mix-blend-multiply'}`}

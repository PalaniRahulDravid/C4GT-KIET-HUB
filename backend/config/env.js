...
const config = {
  ...
  frontendUrl: process.env.FRONTEND_URL || 'https://c4gt-team6.vercel.app',
...
if (!config.mongoUri) {
  ...
  console.warn('Warning: MONGODB_URI / MONGO_URI / DATABASE_URL is not set in environment configuration.');
}
